...
class ApiKaryawanController extends Controller
{
    ...
    public function index(){
        $data = DB::table($this->table)
                ->select($this->table.".*",DB::raw("m_wilayah_penugasan.nama as penugasan"))
                ->join("m_wilayah_penugasan","m_wilayah_penugasan.id","=",$this->table.".id_wilayah_penugasan")
                ->get();
    ...
    public function store(Request $request){
        ...
        try {
            $pushdata = array(
                ...
                "id_wilayah_penugasan" => $request->wilayah_penugasan,
