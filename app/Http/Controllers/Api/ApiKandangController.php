...
use DataTables;
class ApiKandangController extends Controller
{
    private $table = "m_kandang";
    private $pk_table = "";
    ...
    public function index(){
        $data = DB::table($this->table)
                ->select($this->table.".*",DB::raw("m_peternak.nama as peternak"),DB::raw("m_wilayah_penugasan.nama as wilayah"))
                ->join("m_peternak",$this->table.".id_peternak","=","m_peternak.id")
                ->join("m_wilayah_penugasan",$this->table.".id_wilayah_penugasan","=","m_wilayah_penugasan.id")
                ->get();
    ...
    public function store(Request $request){
        ...
        try {
            $pushdata = array(
                ...
                "id_wilayah_penugasan" => $request->wilayah,
